    ...
    <div class="menu">
        ...
        <div class="menu-item dropdown dropdown-mobile-full">
            ...
            <div class="dropdown-menu fade dropdown-menu-end w-300px text-center p-0 mt-1">
                <div class="row row-grid gx-0">
                    ...
                    <div class="col-4">
                        <a href="/pos/customer-order" target="_blank" class="dropdown-item text-decoration-none p-3 bg-none">
        ...
        <div class="menu-item dropdown dropdown-mobile-full">
            <a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link">
                ...
                <div class="menu-text d-sm-block d-none">PKATEMA78277</div>
            </a>
            <div class="dropdown-menu dropdown-menu-end me-lg-3 fs-11px mt-1">
                ...
                <a class="dropdown-item d-flex align-items-center" href="/email/inbox">INBOX <i class="bi bi-envelope ms-auto text-theme fs-16px my-n1"></i></a>
                ...
                <a class="dropdown-item d-flex align-items-center" href="/page/login">LOGOUT <i class="bi bi-toggle-off ms-auto text-theme fs-16px my-n1"></i></a>
            </div>
        </div>
    </div>
    <!-- END menu -->
